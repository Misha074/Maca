...
var _swiperIntro = require("./modules/swiper-intro/swiper-intro");
var _swiperPrograms = require("./modules/swiper-programs/swiper-programs");
var _initTabs = require("./modules/tabs/init-tabs");
var _swiperCommon = require("./modules/tabs/swiper-common/swiper-common");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _swiperIntro.initIntroSwiper)();
  ...
  window.addEventListener('load', function () {
    (0, _swiperPrograms.initProgramsSwiper)();
    (0, _initTabs.initTabs)();
    (0, _swiperCommon.initCommonSwiper)();
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/leaflet/init-leaflet":11,"./modules/modals/init-modals":13,"./modules/nav-toggle/nav-toggle":15,"./modules/scroll/scroll":16,"./modules/swiper-intro/swiper-intro":17,"./modules/swiper-programs/swiper-programs":18,"./modules/swiper-reviews/swiper-reviews":19,"./modules/tabs/init-tabs":20,"./modules/tabs/swiper-common/swiper-common":21,"./utils/ios-vh-fix":25}],2:[function(require,module,exports){
"use strict";
...
exports.accordions = accordions;
var accordionContent = document.querySelectorAll('.accordion__content--nojs');
...
var programsLink = document.getElementById('programs-link');
...
var participateLink = document.getElementById('participate-link');
participateLink.addEventListener('click', function () {
  participate.scrollIntoView({
    behavior: 'smooth'
  }, {
    block: 'center',
    inline: 'center'
...
exports.initIntroSwiper = initIntroSwiper;
...
function initReviewsSwiper() {
  // eslint-disable-next-line no-undef
  var programsSwiper = new Swiper('.reviews__swiper', {
    // Буллеты пагинации (кликабельные)
    pagination: {
      el: '.swiper-pagination',
      type: 'progressbar'
...
},{"./tabs":22}],21:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initCommonSwiper = initCommonSwiper;
function initCommonSwiper() {
  // eslint-disable-next-line no-undef
  var programsSwiper = new Swiper('.common__swiper', {
    // Буллеты пагинации (кликабельные)
    navigation: {
