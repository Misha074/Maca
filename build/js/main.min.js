...
var _swiperNews = require("./modules/swiper-news/swiper-news");
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/leaflet/init-leaflet":11,"./modules/modals/init-modals":13,"./modules/nav-toggle/nav-toggle":15,"./modules/scroll/scroll":16,"./modules/swiper-intro/swiper-intro":17,"./modules/swiper-news/swiper-news":18,"./modules/swiper-programs/swiper-programs":19,"./modules/swiper-reviews/swiper-reviews":20,"./modules/tabs/init-tabs":21,"./utils/ios-vh-fix":25}],2:[function(require,module,exports){
"use strict";
...
var firstInput = formModal.getElementsByTagName('input');
...
function initNewsSwiper() {
  // eslint-disable-next-line no-undef
  var programsSwiper = new Swiper('.news__swiper', {
    // Буллеты пагинации (кликабельные)
    navigation: {
